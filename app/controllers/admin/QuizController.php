...
class QuizController extends AdminController
{
    ...
    public function create()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $result = $this->quizModel->createQuiz($subject_id, $question, $mark, $options, $correct_option);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            foreach ($questions as $question) {
                ...
                if ($correct_option > 0) {
                    ...
                    $result = $this->quizModel->createQuiz($subject_id, $question['title'], $mark, $options, $correct_option);
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $mark = (float) $_POST['mark'];
            header('Content-Type: application/json');
            $result = $this->quizModel->updateQuiz($id, $question, $mark, $options, $correct_option);
            echo json_encode($result);
