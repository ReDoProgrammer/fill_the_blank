...
<div class="container">
    ...
    <script>
        ...
        $btnSubmit.click(function () {
            ...
            let url = `<?php echo BASE_URL; ?>/teacher/exam/${id > 0 ? 'update' : 'create'}`;
...
console.log(exams);
                    ...
                    exams.forEach(e => {
                        ...
                        <tr class="align-middle">
                            ...
                            <td class="text-center">
                                ...
                                ${(e.random_of_questions == 0 && e.available) ? `<a href="<?php echo BASE_URL; ?>/teacher/exam/customize?id=${e.id}"><i class="fa fa-list text-success" aria-hidden="true"></i></a>` : ''}
        ...
        function DeleteExam(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo BASE_URL; ?>/teacher/exam/delete',
                        type: 'POST',
                        data: {
                            id
                        },
        ...
        function GetDetail(id) {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<?php echo BASE_URL; ?>/teacher/exam/detail',
                    type: 'get',
                    dataType: 'json',
                    data: {
                        id
