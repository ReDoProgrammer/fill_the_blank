<div class="card text-white bg-success">
    <h5 class="card-header mb-3 d-flex justify-content-between align-items-center">
        <span>
            ...
            Thông tin bài thi <span class="text-warning"><?php echo $subject; ?></span>
        </span>
    ...
    <div class="card-body bg-white text-dark">
        ...
        <div class="container mb-5 mt-3" style="text-align: center;">
            <div class="text-center">
                <img src="<?php echo !empty($exam["exam"]["thumbnail"]) ? $exam["exam"]["thumbnail"] : BASE_URL . '/public/assets/images/no_image.jpg'; ?>" class="img-thumbnail" alt="..." style="width:350px; height:auto;">
            </div>
            <h4 class="text-info fw-bold"><?php echo $exam["exam"]["title"]; ?></h4>
            <h6 class ="text-secondary">Ngày bắt đầu: <?php echo $exam["exam"]["begin_date"];?></h6>
            <h6 class ="text-secondary">Ngày kết thúc: <?php echo $exam["exam"]["end_date"];?></h6>
            <h6 class ="text-secondary">Số câu hỏi: <?php echo $exam["exam"]["number_of_questions"];?></h6>
            <h6 class ="text-secondary">Thời lượng: <?php echo $exam["exam"]["duration"];?> phút</h6>
            <p><?php echo $exam["exam"]["description"];?></p>
            <a class="btn btn-md btn-success btn-exam mt-3" href="javascript:void(0)" onClick="DoExam(<?php echo $exam["exam"]["id"];?>,'<?php echo BASE_URL; ?>/exam/doing?id=<?php echo $exam["exam"]["id"];?>')">Làm bài thi</a>
        </div>
