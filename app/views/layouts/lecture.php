            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    classese.forEach(c => {
                        ...
                        $classes.append(`<li id="${c.teaching_id}"><a class="dropdown-item" href="<?php echo BASE_URL; ?>/teacher/classroom/index?r=${c.teaching_id}&y=${c.school_year}" target="_self">${c.class_name} - ${c.school_year}</a></li>`);

                        // Thêm exam vào $exams
                        $exams.append(`<li><a class="dropdown-item" href="<?php echo BASE_URL; ?>/teacher/exam/index?r=${c.teaching_id}&y=${c.school_year}" target="_self">${c.class_name} - ${c.school_year}</a></li>`);
